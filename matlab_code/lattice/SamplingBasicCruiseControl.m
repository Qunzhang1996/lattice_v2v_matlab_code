function [terminalStates, times] = SamplingBasicCruiseControl(refPath, laneWidth, laneBounds, egoState, targetVelocity, dt)
...
% Copyright 2020 The MathWorks, Inc.
    ...
    futureLane = PredictLane(frenetState, laneWidth, laneBounds, dt);
