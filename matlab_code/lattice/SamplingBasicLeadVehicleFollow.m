function [terminalStates, times] = SamplingBasicLeadVehicleFollow(refPath, laneWidth,laneBounds, safetyGap, egoState, actorState, dt)
...
% Copyright 2020 The MathWorks, Inc.
    ...
    curEgoLane = PredictLane(frenetStateEgo, laneWidth, laneBounds, 0);
    ...
    for i = 1:size(actorState,1)
        predictedActorLanes(:,i) = PredictLane(frenetStateActors(i,:),laneWidth, laneBounds,dt);
    end
